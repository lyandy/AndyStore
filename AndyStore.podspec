#
#  Be sure to run `pod spec lint AndyStore.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/lyandy/AndyStore"
  ...
  s.source       = { :git => "https://github.com/lyandy/AndyStore.git", :tag => s.version }
  ...
  # s.frameworks = "Foundation", "AndyExtension"
  ...
  s.dependency "AndyExtension", "~> 1.0.7"
